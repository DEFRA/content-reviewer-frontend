#!/usr/bin/env pwsh
# Test script for Content Reviewer Frontend - DEV environment

$ErrorActionPreference = "Stop"

Write-Host "======================================" -ForegroundColor Cyan
Write-Host "Content Reviewer Frontend - DEV Tests" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""

$frontendUrl = "https://content-reviewer-frontend.dev.cdp-int.defra.cloud"
$expectedBackendUrl = "https://content-reviewer-backend.dev.cdp-int.defra.cloud"
...
# Summary
Write-Host "======================================" -ForegroundColor Cyan
Write-Host "Frontend Test Summary - DEV" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
